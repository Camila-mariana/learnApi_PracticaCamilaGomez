...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                //csrf para cerrar la api y solo resiva peticiones de donde se le diga
                ...
                .authorizeHttpRequests(auth -> auth  // Cambia authorizeRequests por authorizeHttpRequests
                        ...
                        //sin importar el rol puede hacer la solicitud mientas este autenticado
                        .anyRequest().authenticated())
                .sessionManagement(sess -> sess
                        .sessionCreationPolicy(SessionCreationPolicy.STATELESS))
                //sesiones con STATELESS, sesiones sin estado, o sea las solicitudes se manejan como si fuera la primera vez que se hace
